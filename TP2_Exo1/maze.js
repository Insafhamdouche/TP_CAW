...
function changecolor(){
    ...
    winner = true; //zedt hedi 
var allBoundaries = document.getElementsByClassName("boundary");
var i;
for(i=0;i<allBoundaries.length;i++){
	allBoundaries[i].style.backgroundColor="red";
